...
class NonlinearSystem:
    ...
    def f(self, x, u):
        ...
        :return:    The subsequent state :math:`x_{k+1}`
        """
...
class Bicycle(NonlinearSystem):
    """
    x:= [p_x, p_y, delta, v, psi]
    u:= [v_delta, a_long]
    y:= x
    """
    def __init__(self, dt, l_wb):
        self.dt = dt
        self.l_wb = l_wb
