...
class Problem_IV(ProblemBase):
    ...
    def init_scenario(self):
        ...
        self.obstacle_center2 = (4, 6)               # obstacle center and radius
        self.obstacle_radius2 = 0.5                  # obstacle radius
        self.obstacle_center3 = (6, 4)               # obstacle center and radius
        self.obstacle_radius3 = 0.5                  # obstacle radius
    ...
    def init_specification(self):
        ...
        at_obstacle2 = CirclePredicate(self.obstacle_center2, self.obstacle_radius2, 0, 1, self.sys.p)
        at_obstacle3 = CirclePredicate(self.obstacle_center3, self.obstacle_radius3, 0, 1, self.sys.p)
        not_at_obstacle = at_obstacle.negation()
        not_at_obstacle2 = at_obstacle2.negation()
        not_at_obstacle3 = at_obstacle3.negation()

        # Put all the constraints together in one specification
        spec = not_at_obstacle.always(0, self.K) & not_at_obstacle2.always(0, self.K) & not_at_obstacle3.always(0, self.K) & at_goal.eventually(0, self.K)
        ...
        monitor.name = 'PI Problem IV STL monitor'
    ...
    def plot_scenario(self, ax, k=0):
        ...
        obstacle2 = make_circle_patch(self.obstacle_center2, self.obstacle_radius2, edgecolor='black', facecolor='gray', alpha=1.0)
        obstacle3 = make_circle_patch(self.obstacle_center3, self.obstacle_radius3, edgecolor='black', facecolor='gray', alpha=1.0)
