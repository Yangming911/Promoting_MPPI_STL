...
class Problem_V(ProblemBase):
    ...
    def init_scenario(self):
        self.K = 35                                 # Time horizon
        self.x0 = np.array([1.0, 1.0, 0.0, 0.0])    # Initial state
        self.goal_bounds = (6, 8, 0, 2)             # (x_min, x_max, y_min, y_max)
        self.goal_bounds2 = (0, 2, 6, 8)             # (x_min, x_max, y_min, y_max)
    ...
    def init_specification(self):
        ...
        at_goal2 = inside_rectangle_formula(self.goal_bounds2, 0, 1, self.sys.p)
        ...
        spec = not_at_obstacle.always(0, self.K) & at_goal.eventually(0, self.K) & at_goal2.eventually(0, self.K)
    ...
    def plot_scenario(self, ax, k=0):
        ...
        goal2 = make_rectangle_patch(*self.goal_bounds2,  edgecolor='black', facecolor='skyblue', alpha=0.5)
